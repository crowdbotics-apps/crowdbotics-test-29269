...
## Project Structure
    ...
    ├── crowdbotics_test_29269  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_test_29269`
...
2. Clone this repo and `cd crowdbotics_test_29269`
